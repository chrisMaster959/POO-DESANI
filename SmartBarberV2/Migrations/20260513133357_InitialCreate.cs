        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nr_Logradouro = table.Column<int>(type: "int", nullable: false),
                    Bairro = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CepId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Barbeiro", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Barbeiro_Cep_CepId",
                        column: x => x.CepId,
                        principalTable: "Cep",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Barbeiro_Pessoa_Id",
                        column: x => x.Id,
                        principalTable: "Pessoa",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BarbeirosId = table.Column<int>(type: "int", nullable: false),
                    ServicosId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BarbeiroServico", x => new { x.BarbeirosId, x.ServicosId });
                    table.ForeignKey(
                        name: "FK_BarbeiroServico_Barbeiro_BarbeirosId",
                        column: x => x.BarbeirosId,
                        principalTable: "Barbeiro",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BarbeiroServico_Servico_ServicosId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BarbeiroServico_ServicosId",
